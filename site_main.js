...
const routes = [
    ...
    {
        path: 'chapa',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_chapa_chapa_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./chapa/chapa.module */ 2073)).then(m => m.ChapaPageModule)
    },
    {
        path: 'monedero',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_monedero_monedero_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./monedero/monedero.module */ 7653)).then(m => m.MonederoPageModule)
    },
    {
        path: 'barra',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_barra_barra_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./barra/barra.module */ 4141)).then(m => m.BarraPageModule)
    },
];
...
let AppComponent = class AppComponent {
    ...
    initializeApp() {
        this.platform.ready().then(() => {
            document.body.classList.remove('dark'); // Elimina la clase dark si está presente
        });
    }
};
